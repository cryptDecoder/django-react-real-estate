...
class Listing(models.Model):
    ...
    sale_type = models.CharField(
        max_length=100, choices=SALE_CHOICE, default='FOR_SALE')
    price = models.IntegerField()
    bedrooms = models.IntegerField()
    bathrooms = models.DecimalField(max_digits=2, decimal_places=1)
    home_types = models.CharField(
        max_length=100, choices=HOME_TYPES, default='HOUSE')
    ...
    photo_21 = models.ImageField(upload_to='photo/%y/%m/%d/', blank=True)
    photo_22 = models.ImageField(upload_to='photo/%y/%m/%d/', blank=True)
